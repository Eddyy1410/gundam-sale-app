            ...
            if (productRepository.findAll().isEmpty()) {
                ...
                productRepository.saveAll(List.of(
                        ...
                        Product.builder()
                                ...
                                .quantity(150)
                                .category(categoryRepository.findById(2))
                                .build(),
                        ...
                        Product.builder()
                                ...
                                .quantity(60)
                                .category(categoryRepository.findById(3))
                                .build(),
                        ...
                        Product.builder()
                                ...
                                .quantity(65)
                                .category(categoryRepository.findById(5))
                                .build(),
                        ...
                        Product.builder()
                                ...
                                .quantity(45)
                                .category(categoryRepository.findById(6))
                                .build(),
                        ...
                        Product.builder()
                                ...
                                .quantity(25)
                                .category(categoryRepository.findById(7))
                                .build(),
                        ...
                        Product.builder()
                                ...
                                .quantity(15)
                                .category(categoryRepository.findById(8))
                                .build(),
                        ...
                        Product.builder()
                                ...
                                .quantity(20)
                                .category(categoryRepository.findById(9))
                                .build(),
                        ...
                        Product.builder()
                                ...
                                .quantity(18)
                                .category(categoryRepository.findById(11))
                                .build(),
                        ...
                        Product.builder()
                                ...
                                .quantity(95)
                                .category(categoryRepository.findById(12))
                                .build(),
                        ...
                        Product.builder()
                                ...
                                .price(BigDecimal.valueOf(250000))
                                .quantity(120)
                                .category(categoryRepository.findById(13))
                                .build()
                ));
            }
